...
export namespace Phase {
  ...
  export const VRT_CATEGORIES_BY_TYPE: Record<string, Array<{ category: string; path: string }>> = {
    ...
    infrastructure: [
      ...
      { category: "Info Disclosure", path: "Information Disclosure > Service Exposure" },
      { category: "Cloud Misconfig", path: "Security Misconfiguration > Cloud Provider > Overprivileged IAM" },
      { category: "Public Storage", path: "Security Misconfiguration > Cloud Provider > Public Storage Bucket" },
      { category: "Missing Encryption", path: "Cryptographic Failures > Missing Encryption at Rest" },
      { category: "Logging Gap", path: "Security Misconfiguration > Insufficient Logging > Cloud Audit Trail" },
      { category: "Network Exposure", path: "Security Misconfiguration > Cloud Provider > Open Security Group" },
      { category: "Metadata Exposure", path: "Information Disclosure > Cloud Metadata > IMDSv1 Enabled" },
    ],
    vulnerability_hint: [],
    business_rule: [],
    sensitive_data: [],
